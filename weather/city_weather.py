...
class CityWeather:
    ...
    def get_city_weather(self):
        ...
        self.sunrise = datetime.utcfromtimestamp(int(str(raw_weather_data['current']['sunrise']))).strftime('%H:%M:%S')
        self.sunset = datetime.utcfromtimestamp(int(str(raw_weather_data['current']['sunset']))).strftime('%H:%M:%S')